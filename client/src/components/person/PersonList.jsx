...
const PersonList = ({ peopleList, onPersonEdit, onPersonDelete }) => {
  if (!peopleList || peopleList.length === 0) {
    return (
      <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 text-center text-gray-500 mt-6">
        <p className="text-lg font-medium">No people found</p>
        <p className="text-sm mt-1">Add some people using the form above.</p>
      </div>
    );
  }
